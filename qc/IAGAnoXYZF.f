	      ...
	      if(ih*100+im .ge. hron*100+minon) then
		   ...
		   ! If you would want to remove F too:
                   ...
                   ! If you want to remove X&Y components:
                     line(33:40) = '99999.00'                   
                     line(43:50) = '99999.00'
                   ! You cannot have XYZ & F be 99999.00 because the Intermagnet system then will not overwrite the previous and instead ignores the line with 99999.00 for all components. Using 88888.00 for F instead doesn't make a difference!!!               
                    line(52:60) = ' 99999.00'
