...
c   Note: if you have XYZ & F be 99999.00 and re-send the data to Intermagnet system then it 
c   will not overwrite the previously submitted data file. You have to ask Simon Flower via 
c   email to delete the whole day. Then you re-submit the day with all 4 components being 99999.00 
c   for dud data.            
!   Call as IAGAnoXYZF eyr 12 12 31 1130 1240
!
	implicit none
