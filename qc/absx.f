...
!   to the values found in the apx,eyx,sbx files, e.g. 130101.sbx 
!   This is used to calculate the instrumental constants 
!   MUST RUN in directory above stn/*.sbx etc., where stn is 3-letter station code
...
!   Benmore correction HARD-WIRED at 0.14 - Good for 2013 onwards. 
!   Currently does not handle 9999999 for no reading. Effect will generally be obvious    
