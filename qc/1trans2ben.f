...
c	write(14,1400) hr, min, sec, -0.0066 * ben 
...
!  Now read .prn file. Each new hour needs a new output file
	do i = 1, 1000000
	   ...
	   write(14,1400) hr, min, sec+1, -0.0028 * ben -0.27
	   write(14,1400) hr, min, sec+2, -0.0028 * ben -0.27
	   write(14,1400) hr, min, sec+3, -0.0028 * ben -0.27
	   write(14,1400) hr, min, sec+4, -0.0028 * ben -0.27
	   hrp = hr
	end do
100	continue
